  ...
  */
  ...
  if (sources.length > 0) {
    ...
    for (idx = 0, _len3 = sources.length; idx < _len3; idx++) {
      ...
      for (_l = 0, _len6 = _ref4.length; _l < _len6; _l++) {
        c = _ref4[_l];
        renderMarkdown(c);
        _ref5 = c.staticmethods;
        for (_m = 0, _len7 = _ref5.length; _m < _len7; _m++) {
          m = _ref5[_m];
          renderMarkdown(m);
        }
        _ref6 = c.instancemethods;
        for (_n = 0, _len8 = _ref6.length; _n < _len8; _n++) {
          m = _ref6[_n];
          renderMarkdown(m);
        }
      }
      _ref7 = documentation.module.functions;
      for (_o = 0, _len9 = _ref7.length; _o < _len9; _o++) {
        f = _ref7[_o];
        renderMarkdown(f);
      }
