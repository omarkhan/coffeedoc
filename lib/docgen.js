(function() {
  ...
  */  var coffeedoc, css, eco, fs, path, renderMarkdown, s, showdown, source_names, sources, template;
  ...
  if (sources.length > 0) {
    fs.mkdir('docs', '755', function() {
      var c, cls, clspath, documentation, f, html, idx, m, module_filename, module_path, prefix, script, source, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _ref, _ref2, _ref3, _ref4;
      ...
      return fs.mkdir('docs/resources', '755', function() {
