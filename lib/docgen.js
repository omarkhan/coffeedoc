  ...
  */  var coffeedoc, css, eco, fs, path, renderMarkdown, showdown, sources, template;
  ...
  if (sources.length > 0) {
    fs.mkdir('docs', '755', function() {
      var c, documentation, f, html, m, script, source, _i, _j, _k, _l, _len, _len2, _len3, _len4, _ref, _ref2, _ref3;
      for (_i = 0, _len = sources.length; _i < _len; _i++) {
        ...
        fs.writeFile('docs/' + path.basename(source, path.extname(source)) + '.html', html);
      }
